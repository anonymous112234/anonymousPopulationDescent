...
def create_Parameters_NN_object(pop_size, randomization, CV_selection, rr, lr):
	history = []
...
if __name__ == "__main__":
	...
	for it in iterations:
		...
		# set seed
		set_global_determinism(seed=SEED[0])

		#creating object to pass into pop descent
		Parameters_object, model_num = create_Parameters_NN_object(pop_size, randomization, CV_selection, rr, 0.001)
		...
		optimized_population, lfitnesses, vfitnesses, history = populationDescent(Parameters_object, number_of_replaced_individuals = number_of_replaced_individuals, iterations = it)
		...
		data = [[best_test_model_loss, best_train_model_loss, grad_steps, model_num, CV_selection, randomization, iterations, pop_size, number_of_replaced_individuals, rr, input_factor, epochs, batches, batch_size, lr, time_lapsed, SEED[0]]]

		with open('../PD_CIFAR_Sensitivity_it.csv', 'a', newline = '') as file:
