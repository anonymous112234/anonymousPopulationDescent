...
if __name__ == "__main__":
	...
	for lr in lrs:
		...
		Parameters_object, model_num = create_Parameters_NN_object(pop_size, randomization, CV_selection, rr, lr)
		...
		with open('../PD_CIFAR_Sensitivity_lr.csv', 'a', newline = '') as file:
